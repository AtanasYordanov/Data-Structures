...
import FirstLastList.AVL;
import FirstLastList.Node;
...
public class AVLTests {
    ...
    @Test(timeout = 250)
    public void insert_Multiple_Elements_Performance() {
        AVL<Product> avl = new AVL<Product>();

        for (int i = 0; i < 1000000; i++) {
            avl.insert(new Product(i, null));
        }
        Assert.assertTrue(avl.contains(new Product(999999, null)));
    }
}
